  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
      ...
      <View style={{ flexDirection: 'row' }}>
        <TextInput
          style={{ marginRight: 10, paddingHorizontal: 10, height: 40, width: 50, borderColor: 'gray', borderWidth: 1 }}
          placeholder="0"
        ...
        <TextInput
          ref={otp4Ref}
          style={{ paddingHorizontal: 10, height: 40, width: 50, borderColor: 'gray', borderWidth: 1 }}
          placeholder="0"
          keyboardType="numeric"
          maxLength={1}
          value={otp4}
      ...
      <Button
        ...
        disabled={!otp1 || !otp2 || !otp3 || !otp4 || isVerified}
      />
      <Modal
        animationType="slide"
        transparent={true}
